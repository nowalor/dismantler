                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <img class="card-img-bottom mt-2"
                                 src="{{ count($carPart->carPartImages) ? asset("storage/img/car-part/{$carPart->id}/{$carPart->carPartImages[0]->image_name}") : 'http://46.101.206.99/storage/img/car-part/placeholder.jpg' }}"
                                 alt="">
                        </div>
                    </div>
                </div>
