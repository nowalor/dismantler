...
<div class="cta">
    ...
    <div class="d-flex justify-content-center gap-3 mt-5">
        ...
        <div class="col-3 mb-3 text-center">
            <a href="#" class="fw-semibold btn btn-success mb-3">SEARCH BY HSN + TSN</a>
            <div class="card" style="z-index:5; height: 30rem;">
        ...
        <!-- Car Model Section -->
        <div class="col-3 mb-3 text-center">
            <a href="#" class="fw-semibold btn btn-success mb-3">SEARCH BY CAR MODEL</a>
            <div class="card" style="z-index:5; height: 30rem;">
                <div class="card-header">
        ...
        <!-- OEM Section -->
        <div class="col-3 mb-3 text-center">
            <a href="#" class="fw-semibold btn btn-success mb-3">SEARCH BY OEM</a>
            <div class="card" style="z-index:5; height: 30rem;">
